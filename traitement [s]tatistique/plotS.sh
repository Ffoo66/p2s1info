...
gnuplot -persist <<-EOFMarker
	...
	plot 'results.dat' using 1:3:4 with filledcurve fc rgb Shadecolor title "Intervalle des distances par trajet",'' using 1:2 smooth mcspline lw 2   title "Moyenne des distances par trajet"
	pause -1 "\n"
EOFMarker
